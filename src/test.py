...
# text=""""Anh ngố"trợn trừng hai mắt, nhìn chằm chằm vào nóc nhà được tạo thành từ cỏ dại và bùn trộn lẫn. Toàn thân hắn được trùm bởi một cái áo bông đã cũ, ố vàng, nhìn không còn ra hình dạng ban đâu, phảng phất tán phát ra một ít mùi ẩm mốc.
...
# print(f"Number of token: {token_length_function(text)}")
# print(f"Number of token: {embedding_client.calculate_token(text)}")
...
# from generator.defaults import ANSWER_PROMPT, VALIDATE_CONTEXT_PROMPT, SUMMARIZE_PROMPT
...
# llm = Llama3Engine(
#     base_url="http://localhost:8888/v1",  # "http://<Your api-server IP>:port"
#     api_key="sk-no-key-required",
#     temperature=0,
#     # model="gpt-3.5-turbo"
# )
# query = "Phát hiện ra bí mật thúc dục thực vật của bình nhỏ, âm thầm điều chế đan dược tu luyện"
...
data_path = "/home/sontt/workspaces/craw_truyen/pntt_10_chapter.json"
